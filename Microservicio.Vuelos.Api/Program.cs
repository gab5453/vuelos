...
builder.Services.AddVuelosCors(builder.Configuration);
...
builder.Services.AddAeropuertosModule();
builder.Services.AddVuelosApplicationServices(builder.Configuration);
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "Vuelos API v1");
