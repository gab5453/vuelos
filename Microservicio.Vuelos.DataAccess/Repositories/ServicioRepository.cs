...
/// Gestiona los proveedores registrados (Vuelos.servicio).
...
public class ServicioRepository : IServicioRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var query = QueryVigentes
            .Where(s =>
                EF.Functions.Like(s.RazonSocial, patron) ||
                (s.NombreComercial != null && EF.Functions.Like(s.NombreComercial, patron)))
            .OrderBy(s => s.RazonSocial);
