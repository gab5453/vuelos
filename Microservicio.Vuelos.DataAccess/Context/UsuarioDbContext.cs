...
using Microservicio.Vuelos.DataAccess.Configurations;
...
public class UsuarioDbContext : DbContext
{
    ...
    /// <summary>
    /// Tabla Vuelos.usuario_app — credenciales y estado del usuario.
    /// </summary>
    public DbSet<UsuarioAppEntity> Usuarios { get; set; }

    /// <summary>
    /// Tabla Vuelos.rol — catálogo de roles del sistema.
    /// </summary>
    public DbSet<RolEntity> Roles { get; set; }

    /// <summary>
    /// Tabla puente Vuelos.usuarios_roles — asignación N:M usuario-rol.
    /// </summary>
